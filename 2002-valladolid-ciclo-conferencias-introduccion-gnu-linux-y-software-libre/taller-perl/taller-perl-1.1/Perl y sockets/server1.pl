...
# Modelo de servidor con comunicacion bidireccional 
...
# 7. Recibimos la peticion y si no estamos muy ocupados le mandamos la hora 
$pet = <C>; 
chop $pet; 
print "Recibida del cliente la peticion: $pet\n"; 
